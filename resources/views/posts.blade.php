<x-layout>
            ...
            <form action="/posts" method="get">
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        placeholder="Search Artikel" type="search" id="search" name="search">
                    </div>
                    <div>
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        ...
        @empty
        <div>
            <p>Artikel indak ado</p>
            <a href="/posts" class="block text-blue-600 hover:underline">&leftarrowtail; Back to artikel</a>
        </div>
        @endforelse
    </div>
    </div>
